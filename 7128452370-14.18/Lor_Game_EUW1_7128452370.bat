...
:start
@start "" "League of Legends.exe" "spectator r.leagueofreplays.co:80 S9ZIJJrftvWthb2L2zjmXFGlifJyykG1 7128452370 EUW1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
