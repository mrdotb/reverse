...
:start
@start "" "League of Legends.exe" "spectator r.leagueofreplays.co:80 dvi/swgJkjLtz4VpHeGPbAt5RxCKPiaZ 7134993844 EUW1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
...
:notfound
cls
echo Cannot find your League of Legends installation. (If the issue persists, contact hello@leagueofreplay.co)
